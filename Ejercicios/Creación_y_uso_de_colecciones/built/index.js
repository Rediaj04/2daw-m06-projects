...
const categorias = new Set(['Electrónica', 'Ropa', 'Juguetes']);
...
function AñadirC() {
    const input = document.getElementById("AñadirCa");
...
function MostrarC() {
    const categoriasParrafo = document.getElementById("categorias");
...
function AñadirP() {
    const input = document.getElementById("AñadirPo");
    const inputCantidad = document.getElementById("AñadirPoCant");
...
function MostrarP() {
    const productosParrafo = document.getElementById("productos");
    if (productos.size > 0) {
...
function VenderProducto() {
    const inputProducto = document.getElementById("ProductoVenta");
...
function MostrarVentas() {
    const ventasParrafo = document.getElementById("ventas");
    if (ventas.length > 0) {
...
function MostrarBeneficios() {
    const beneficiosParrafo = document.getElementById("beneficios");
