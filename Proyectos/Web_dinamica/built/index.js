...
let negrillas = document.getElementById("cbox1");
let subrayar = document.getElementById("cbox2");
let curvado = document.getElementById("cbox3");
let normal = document.getElementById("cbox4");
...
function removeSpecificElement(texto) {
...
eliminarElementoBtn.addEventListener("click", () => {
    let elementoEliminarInput = document.getElementById("elementoEliminar");
